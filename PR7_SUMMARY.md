...
| --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `SESSION_SECRET`, `JWT_SECRET`, `DATABASE_URL`, SMTP (`SMTP_HOST`, `SMTP_PORT`, `SMTP_USER`, `SMTP_PASS`, `SMTP_FROM`, `SMTP_FROM_NAME`), lots (`PRIZE_HMAC_SECRET`, `PRIZE_REDEEM_BASE_URL`, `PRIZE_UNSUBSCRIBE_BASE_URL`) | `CORS_ORIGINS` ; observabilité : `SENTRY_DSN_API`, `NEXT_PUBLIC_SENTRY_DSN_ADMIN`, `NEXT_PUBLIC_SENTRY_DSN_CONSOLE`, `NEXT_PUBLIC_SENTRY_DSN_PLAYER`, `NEXT_PUBLIC_SENTRY_DSN_MOBILE`, `SENTRY_ENVIRONMENT`, `ADMIN_ALERT_EMAILS`, `HEALTH_CHECK_TOKEN` (voir `PR8_SUMMARY`) |
